...
#define CONFIG_FASTBOOT_VENDOR_ID      0x0bb4
...
#define CONFIG_ENV_MMC_OFFSET		(768 * 512)
#define CONFIG_ENV_MMC_SIZE		CONFIG_ENV_SIZE

#define CONFIG_ENV_SF_OFFSET		(768 * 1024)
#define CONFIG_ENV_SF_SIZE		CONFIG_ENV_SIZE
